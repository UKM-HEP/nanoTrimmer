...
int main(int argc, char **argv) {
  ...
  df = Helper::ironing( df , "Muon_pt" , 1 ).Filter( "Muon_pt1>3" , "POST-PRO: events with 1st muon pt > 3 GeV" );
  df = Helper::ironing( df , "Muon_pt" , 2 ).Filter( "Muon_pt2>3" , "POST-PRO: events with 2nd muon pt > 3 GeV" );
