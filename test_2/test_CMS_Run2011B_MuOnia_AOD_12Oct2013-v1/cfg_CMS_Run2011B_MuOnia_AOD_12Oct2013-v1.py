...
files = FileUtils.loadListFromFile('/afs/cern.ch/work/s/shoh/analysis/opendata/CMSSW_5_3_32/src/workspace/AOD2NanoAOD/test/CMS_Run2011B_MuOnia_AOD_12Oct2013-v1.txt') # FileUtils.loadListFromFile("data/CMS_Run2012B_DoubleMuParked_AOD_22Jan2013-v1_10000_file_index.txt")
...
goodJSON = "/afs/cern.ch/work/s/shoh/analysis/opendata/CMSSW_5_3_32/src/workspace/AOD2NanoAOD/data/Cert_160404-180252_7TeV_ReRecoNov08_Collisions11_JSON.txt"
...
process.aod2nanoaod = cms.EDAnalyzer("AOD2NanoAOD", 
                                     ...
                                     HLTlist = cms.string("/afs/cern.ch/work/s/shoh/analysis/opendata/CMSSW_5_3_32/src/workspace/AOD2NanoAOD/data/HLT/HLT_Lepton_7TeV.txt")
)
process.TFileService = cms.Service(
    "TFileService", fileName=cms.string("/afs/cern.ch/work/s/shoh/analysis/opendata/CMSSW_5_3_32/src/workspace/AOD2NanoAOD/test/test_CMS_Run2011B_MuOnia_AOD_12Oct2013-v1/CMS_Run2011B_MuOnia_AOD_12Oct2013-v1.root"))
