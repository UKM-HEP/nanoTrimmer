...
files = FileUtils.loadListFromFile('/afs/cern.ch/work/s/shoh/analysis/opendata/CMSSW_5_3_32/src/workspace/AOD2NanoAOD/test/CMS_MonteCarlo2011_JPsiToMuMu_2MuPEtaFilter_7TeV-pythia6-evtgen-v2_AODSIM_PU_S13_START53_LV6-v1.txt') # FileUtils.loadListFromFile("test/CMS_MonteCarlo2012_test_ZZTo4e_8TeV-powheg-pythia6.txt")
...
process.GlobalTag.connect = cms.string('sqlite_file:START53_LV6A1.db')
...
process.TFileService = cms.Service(
    "TFileService", fileName=cms.string("/afs/cern.ch/work/s/shoh/analysis/opendata/CMSSW_5_3_32/src/workspace/AOD2NanoAOD/test/test_CMS_MonteCarlo2011_JPsiToMuMu_2MuPEtaFilter_7TeV-pythia6-evtgen-v2_AODSIM_PU_S13_START53_LV6-v1/CMS_MonteCarlo2011_JPsiToMuMu_2MuPEtaFilter_7TeV-pythia6-evtgen-v2_AODSIM_PU_S13_START53_LV6-v1.root"))
